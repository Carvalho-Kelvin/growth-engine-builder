  ...
  const cards = [
    {
      ...
      problem: "Drowning in spreadsheets and manual emails",
    ...
    },
    {
      ...
      problem: "Outdated website that cost you sales",
      solution: "A fast, custom experience that impresses clients",
      accent: "bg-cta",
    },
    {
      icon: TrendingUp,
      title: "Capture Every Lead",
      problem: "Visitors leaving without taking action",
      solution: "Smart tools that turn clicks into customers",
      accent: "bg-accent",
    },
  ];
